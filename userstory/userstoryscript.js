...
document.EditStory = function(storynum){
  ...
  2) If user is "Administrator", proceed to step 5
  3) If user is "Member", proceed to step 6
  4) If user is "Viewer" or NaN, do a pop up to show that they cannot edit as they need the required role 
  5) Administrator - pop up a new window and show all textbox to edit the user story
